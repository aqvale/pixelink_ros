...
#define ApiSuccessParametersChanged  0x00000001  /* Indicates that a feature was set successfully, but one or more parameters had to be changed */
#define ApiSuccessAlreadyRunning     0x00000002  /* The stream is already started */
#define ApiSuccessLowMemory          0x00000003  /* There is not as much memory as needed for optimum performance. Performance may be affected. */
#define ApiSuccessParameterWarning   0x00000004  /* The operation completed successfully, but one or more of the parameters are  */
                                                 /* suspect (e.g. using an invalid IP address) */
#define ApiSuccessReducedSpeedWarning 0x00000005 /* The operation completed sucessfully, but the camera is operating at a speed less than it's maximum */
#define ApiSuccessExposureAdjustmentMade 0x00000006 /* The operation completed sucessfully, but the camera had to adjust exposure to accomodate */
#define ApiSuccessWhiteBalanceTooDark   0x00000007 /* The Auto WhiteBalance algorithm could not achieve good results because the auto-adjust area is too dark */
#define ApiSuccessWhiteBalanceTooBright 0x00000008 /* The Auto WhiteBalance algorithm could not achieve good results because the auto-adjust area has too many saturated pxels */
#define ApiSuccessWithFrameLoss      0x00000009  /* The operation completed sucessfully, but some frame loss occurred (the system could not keep pace with the camera */
